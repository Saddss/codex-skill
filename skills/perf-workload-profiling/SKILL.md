...
description: >
  ...
  inference step timing, vLLM forward latency instrumentation.
license: Apache-2.0
metadata:
  author: NVIDIA Corporation
  upstream: https://github.com/NVIDIA/TensorRT-LLM/tree/main/.claude/skills/perf-workload-profiling
  adapted_for: Codex global skills (inference triggers added)
---

> **Vendored from [NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM/tree/main/.claude/skills/perf-workload-profiling) under Apache-2.0.** Use before `perf-nsight-systems` / `perf-nsight-compute-analysis` when you need manual timing harnesses. See `LICENSE-Apache-2.0.txt`.
